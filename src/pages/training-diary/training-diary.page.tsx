                    ...
                    <table className="training-diary__table">
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>620</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>320</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>700</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>620</span></div>
                        </td>
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>30</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>30</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>90</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>30</span></div>
                        </td>
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>410</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>810</span></div>
                        </td>
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>60</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>60</span></div>
                        </td>
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data"><span>830</span></div>
                        </td>
                        <td className="training-diary__cell"></td>
                        <td className="training-diary__cell"></td>
                        <td className="training-diary__cell">
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>1860</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>1130</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>700</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>1860</span></div>
                        </td>
                      ...
                      <tr className="training-diary__row">
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>180</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>90</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>90</span></div>
                        </td>
                        ...
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>30</span></div>
                        </td>
                        <td className="training-diary__cell">
                          <div className="training-diary__data training-diary__data--total"><span>180</span></div>
                        </td>
