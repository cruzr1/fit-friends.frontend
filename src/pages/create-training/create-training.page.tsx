                ...
                <div className="create-training__wrapper">
                  ...
                  <div className="create-training__block">
                    ...
                    <div className="create-training__info">
                      <div className={`custom-select ${isTrainTypeOpen ?
                        'is-open' :
                        'custom-select--not-selected'}`}><span className="custom-select__label">Выберите тип тренировки</span>
                        ...
                        >
                          {Object.values(TrainType).map((type) =>
                            <li key={type} className="custom-select__item" id={type} role='option'>{TrainTypeCaption[type]}</li>
                          )}
                        </ul>
                      </div>
                      ...
                      <div className={`custom-select ${isDurationOpen ?
                        'is-open' :
                        'custom-select--not-selected'}`}><span className="custom-select__label">Сколько времени потратим</span>
                        ...
                        >
                          {Object.values(Duration).map((durationItem) =>
                            <li key={durationItem} className="custom-select__item" id={durationItem} role='option'>{QuestionDurationCaption[durationItem]}</li>
                          )}
                        </ul>
                      </div>
                      <div className="custom-input custom-input--with-text-right">
                      ...
                      <div className={`custom-select ${isLevelOpen ?
                        'is-open' :
                        'custom-select--not-selected'}`}><span className="custom-select__label">Выберите уровень тренировки</span>
                        ...
                        ><span className="custom-select__text"></span><span className="custom-select__icon">
                            ...
                            >
                              {Object.values(Level).map((levelItem) =>
                                <li key={levelItem} className="custom-select__item" id={levelItem} role='option'>{LevelCaption[levelItem]}</li>
                              )}
                            </ul>
                      </div>
                  ...
                  <div className="create-training__block">
                    ...
                    <div className="drag-and-drop create-training__drag-and-drop">
                      <label><span className="drag-and-drop__label" tabIndex={0} >{videoURL || 'Загрузите сюда файлы формата MOV, AVI или MP4'}
