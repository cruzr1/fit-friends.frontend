export default function PopupBuyComponent(): JSX.Element {
  return (
          ...
          <div className="popup__content popup__content--purchases">
            <div className="popup__product">
              <div className="popup__product-image">
                <picture>
                  <source type="image/webp" srcSet="markup/img/content/popup/popup-energy.webp, markup/img/content/popup/popup-energy@2x.webp 2x" /><img src="markup/img/content/popup/popup-energy.jpg" srcSet="markup/img/content/popup/popup-energy@2x.jpg 2x" width="98" height="80" alt="" />
                </picture>
              </div>
