...
export default function TrainingCardComponent({training, trainer, isTrainer}: TrainingCardComponentProps): JSX.Element {
    ...
    <div className={`training-card ${isEdit ? 'training-card--edit': ''}`}>
          ...
          <form action="#" method="get">
            <div className="training-info__form-wrapper">
              ...
              <div className="training-info__price-wrapper">
                ...
                {!isTrainer && <button className="btn training-info__buy" type="button">Купить</button>}
              </div>
            </div>
          </form>
        </div>
      ...
      <div className="training-video">
        ...
        <div className="training-video__buttons-wrapper">
          {!isTrainer && <button className="btn training-video__button training-video__button--start" type="button">Приступить</button>}
